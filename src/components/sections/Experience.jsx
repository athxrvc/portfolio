  ...
  return (
    <div className='pb-16 border-b border-neutral-900'>
      ...
      <motion.h2 
        ...
        className="my-20 text-4xl text-center">EXPERIENCE
      </motion.h2>
             ...
             <motion.div 
              ...
              className="w-full max-w-xl lg:w-3/4">
               ...
               {experience.technologies.map((tech, index) => (
                <span key={index} className="px-2 py-1 mt-4 mr-2 text-sm font-medium rounded text-cyan-400 bg-neutral-900">{tech}</span>
               ))}
            </motion.div>
